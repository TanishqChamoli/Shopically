  ...
  render() {
    return (
      <Router>
        ...
        <Route exact path="/seller/shop" render={props =>
            <div className="App">
            ...
            <Route exact path="/seller/shop/addproduct" render={props =>
            <div className="App">
              <Header name="RK Clothing" />
              <Navbar />
              <SearchBar />
            ...
            <Route exact path="/seller/shop/orders" render={props =>
            <div className="App">
              <Header name="RK Clothing" />
              <Navbar />
              <SearchBar />
            ...
            <Route exact path="/seller/shop/productlist" render={props =>
            <div className="App">
              <Header name="RK Clothing" />
              <Navbar />
              <SearchBar />
            ...
            <Route exact path="/seller/shop/owndetails" render={props =>
            <div className="App">
              <Header name="RK Clothing" />
              <Navbar />
              <SearchBar />
