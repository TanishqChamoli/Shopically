...
INSERT INTO `products` (`id`, `product_id`, `shop_id`, `product_name`, `brand`, `category`, `price`, `tag`, `colour`, `size`, `material`, `product_image`, `product_description`, `upload_date`) VALUES
...
INSERT INTO `shop` (`id`, `shop_name`, `shop_location`, `shop_image`, `email_id`, `owner_name`, `city`, `state`, `pincode`, `telephone`, `mobile`) VALUES
(1, 'shop1', 'moh', '', '', '', '', '', 0, '', ''),
(2, 'shop2', 'chd', '', '', '', '', '', 0, '', ''),
(3, 'shop3', 'moh', '', '', '', '', '', 0, '', ''),
(4, 'shop4', 'pun', '', '', '', '', '', 0, '', ''),
...
INSERT INTO `user` (`user_id`, `user_name`, `address`, `pincode`, `email`, `password`, `mobile`, `gender`, `cart`, `joining_date`) VALUES
(1, 'Tanveer Singh', 'Mohali', 160055, 'germinostiltion@gmail.com', '$2y$10$yGgbYzm6AIh6jd8PS4h6feo31uIIeySkShRv86r2zAKKS6ud2B9Oq', '6283531903', '', NULL, '2020-11-09 00:00:00'),
(2, 'Tanveer Many', 'rfferf', 0, 'tanu@gmail.com', '$2y$10$a2saMBTq9.j0S4NV6NkLGej9SNpTjoDKSjFVV0zBfw49NQDcM6ARS', '0628353190', 'male', NULL, '2020-11-12 00:00:00');
